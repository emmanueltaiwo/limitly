...
import * as __fd_glob_9 from "../content/docs/examples/advanced.mdx?collection=docs"
import * as __fd_glob_8 from "../content/docs/api-reference/types.mdx?collection=docs"
import * as __fd_glob_7 from "../content/docs/api-reference/ratelimit.mdx?collection=docs"
...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_0, "api-reference/meta.json": __fd_glob_1, "examples/meta.json": __fd_glob_2, "getting-started/meta.json": __fd_glob_3, "guides/meta.json": __fd_glob_4, }, {"api-reference/checkratelimit.mdx": __fd_glob_5, "api-reference/createclient.mdx": __fd_glob_6, "api-reference/ratelimit.mdx": __fd_glob_7, "api-reference/types.mdx": __fd_glob_8, "examples/advanced.mdx": __fd_glob_9, "examples/basic.mdx": __fd_glob_10, "examples/custom-strategies.mdx": __fd_glob_11, "getting-started/installation.mdx": __fd_glob_12, "getting-started/introduction.mdx": __fd_glob_13, "getting-started/quick-start.mdx": __fd_glob_14, "guides/error-handling.mdx": __fd_glob_15, "guides/express.mdx": __fd_glob_16, "guides/nextjs.mdx": __fd_glob_17, "guides/typescript.mdx": __fd_glob_18, });