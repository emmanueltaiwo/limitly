    ...
    <section id="features" className="py-32 px-4 sm:px-6 lg:px-8 relative">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          >
            Built for <span className="bg-gradient-to-r from-white via-white/80 to-white/50 bg-clip-text text-transparent">developers</span>
          </motion.h2>
          <motion.p 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {features.map((feature, i) => {
            ...
            return (
              ...
              >
                {/* Glow effect */}
                <div className={`absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-2xl rounded-3xl bg-gradient-to-br ${feature.gradient}`} />
                
                <div className={`relative p-8 sm:p-10 rounded-3xl border border-white/10 bg-gradient-to-br from-white/5 to-white/2 backdrop-blur-xl hover:border-white/30 transition-all duration-500 cursor-pointer h-full overflow-hidden`}>
                  ...
                  <motion.div
                    ...
                    animate={{ x: ["-200%", "200%"] }}
                    transition={{ duration: 4, repeat: Infinity, repeatDelay: i * 0.5 }}
                  />
                  
                  {/* Icon */}
                  <motion.div 
                    className="mb-6 inline-flex p-4 rounded-2xl bg-gradient-to-br from-white/10 to-white/5 group-hover:from-white/20 group-hover:to-white/10 transition-all duration-500 relative overflow-hidden"
                  ...
                  >
                    ...
                    <Icon className={`w-7 h-7 sm:w-8 sm:h-8 text-white relative z-10 bg-gradient-to-br ${feature.iconGradient} bg-clip-text text-transparent`} style={{ WebkitTextFillColor: 'white' }} />
                    <motion.div
                  ...
                  <div className="relative z-10">
                    <h3 className="text-xl sm:text-2xl font-bold mb-4 bg-gradient-to-b from-white to-white/80 bg-clip-text text-transparent">
                      {feature.title}
                    </h3>
