...
import { ChevronRight, Sparkles, Lock, Shield, Zap, ArrowRight } from "lucide-react";
...
export function HeroSection() {
  ...
  return (
    <section ref={heroRef} className="pt-32 pb-40 px-4 sm:px-6 lg:px-8 relative min-h-screen flex items-center overflow-hidden">
      {/* Animated gradient orbs */}
      <motion.div 
        className="absolute top-1/4 left-1/4 w-[800px] h-[800px] bg-gradient-to-br from-white/20 via-white/5 to-transparent rounded-full blur-3xl -z-10"
        animate={{
          scale: [1, 1.2, 1],
          x: [0, 100, 0],
          y: [0, -50, 0],
      ...
      />
      <motion.div 
        className="absolute bottom-1/4 right-1/4 w-[600px] h-[600px] bg-gradient-to-tl from-white/15 via-white/5 to-transparent rounded-full blur-3xl -z-10"
        animate={{
          scale: [1, 1.3, 1],
          x: [0, -80, 0],
          y: [0, 50, 0],
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        <div className="text-center relative">
          ...
          <motion.div 
            ...
            className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-gradient-to-r from-white/10 via-white/5 to-white/10 border border-white/20 backdrop-blur-xl mb-12 relative overflow-hidden group"
          >
            <motion.span 
          ...
          >
            <motion.span 
              className="block bg-gradient-to-b from-white via-white to-white/60 bg-clip-text text-transparent relative inline-block"
            ...
            <motion.span 
              className="block bg-gradient-to-b from-white/90 via-white/60 to-white/30 bg-clip-text text-transparent mt-2 sm:mt-3"
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          >
            {[
              { label: "Open Source", value: "100%", icon: Sparkles, color: "from-yellow-500/20 to-orange-500/10" },
              { label: "Free Forever", value: "No Limits", icon: Lock, color: "from-green-500/20 to-emerald-500/10" },
              { label: "Type Safe", value: "TypeScript", icon: Shield, color: "from-blue-500/20 to-cyan-500/10" },
            ].map((stat, i) => {
              ...
              return (
                ...
                >
                  <div className={`relative p-8 sm:p-10 rounded-3xl border border-white/10 bg-gradient-to-br from-white/5 to-white/2 backdrop-blur-xl hover:border-white/30 transition-all duration-500 text-center overflow-hidden`}>
                    ...
                    <motion.div
                      ...
                      animate={{ x: ["-200%", "200%"] }}
                      transition={{ duration: 3, repeat: Infinity, repeatDelay: i * 0.5 }}
                    />
                    <motion.div
                    ...
                    <div className="relative z-10">
                      <div className="text-4xl sm:text-5xl font-black mb-3 bg-gradient-to-b from-white to-white/70 bg-clip-text text-transparent">
                        {stat.value}
                      </div>
