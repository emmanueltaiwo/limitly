        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex gap-2 items-center">
            <div 
              ...
              style={{ backgroundColor: '#ef4444', border: '1px solid rgba(248, 113, 113, 0.3)' }}
            />
            <div 
              className="w-3 h-3 rounded-full shadow-sm" 
              style={{ backgroundColor: '#eab308', border: '1px solid rgba(250, 204, 21, 0.3)' }}
            />
            <div 
              className="w-3 h-3 rounded-full shadow-sm" 
              style={{ backgroundColor: '#22c55e', border: '1px solid rgba(74, 222, 128, 0.3)' }}
            />
          </div>
          {language && (
